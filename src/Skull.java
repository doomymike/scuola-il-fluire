...
public class Skull extends Enemy {
	...
	/**
	 * Skull
	 * constructor for skull
	 * @param x of skull
	 * @param y of skukll
	 * @param hp number of enemies killed (affects hp)
	 */
	Skull(int x, int y, int hp) {
		super(3 * (hp / 10 + 1), 10, x, y);
	...
	/**
	 * act
	 * the skull moves or attack the player if it can
	 */
	public void act() {
	...
	/**
	 * changeSprite
	 * changes sprite based on location
	 */
	...
	/**
	 * updateSprite
	 * updates sprite based on movement
	 */
